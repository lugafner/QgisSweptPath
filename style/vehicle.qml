        ...
        <layer locked="0" enabled="1" pass="0" id="{9d94e848-c95f-4e47-b460-de2c1de24205}" class="SvgMarker">
          <Option type="Map">
            ...
            <Option type="Map" name="parameters">
              <Option type="Map" name="wheel_angle">
                <Option value="true" type="bool" name="active"/>
                <Option value="'rotate(' || (wheel_angle * -1) || ')'" type="QString" name="expression"/>
          ...
          <data_defined_properties>
            <Option type="Map">
              ...
              <Option type="Map" name="properties">
                <Option type="Map" name="angle">
                  <Option value="true" type="bool" name="active"/>
                  <Option value="degrees( &quot;rotation&quot;)" type="QString" name="expression"/>
                  <Option value="3" type="int" name="type"/>
                </Option>
              </Option>
              <Option value="collection" type="QString" name="type"/>
