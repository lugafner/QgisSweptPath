...
<qgis styleCategories="Symbology" version="3.34.14-Prizren">
  <renderer-v2 referencescale="-1" symbollevels="0" forceraster="0" enableorderby="0" type="singleSymbol">
    <symbols>
      <symbol frame_rate="10" clip_to_extent="1" alpha="1" type="marker" is_animated="0" name="0" force_rhr="0">
        ...
        <layer class="SvgMarker" pass="0" locked="0" id="{9d94e848-c95f-4e47-b460-de2c1de24205}" enabled="1">
          <Option type="Map">
            ...
            <Option type="Map">
              ...
              <Option type="Map" name="properties">
                ...
                <Option type="Map" name="height">
                  <Option value="true" type="bool" name="active"/>
                  <Option value="size_y" type="QString" name="field"/>
                  <Option value="2" type="int" name="type"/>
                </Option>
                <Option type="Map" name="offset">
                  <Option value="true" type="bool" name="active"/>
                  <Option value="array( &quot;offset_x&quot; ,  &quot;offset_y&quot; )" type="QString" name="expression"/>
                  <Option value="3" type="int" name="type"/>
                </Option>
                <Option type="Map" name="width">
                  <Option value="true" type="bool" name="active"/>
                  <Option value="size_x" type="QString" name="field"/>
                  <Option value="2" type="int" name="type"/>
                </Option>
              </Option>
              <Option value="collection" type="QString" name="type"/>
        ...
        <layer class="SimpleMarker" pass="0" locked="0" id="{0dfedd7f-b6c3-46af-8232-f125953b405d}" enabled="1">
          <Option type="Map">
            <Option value="0" type="QString" name="angle"/>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol frame_rate="10" clip_to_extent="1" alpha="1" type="marker" is_animated="0" name="" force_rhr="0">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" type="QString" name="name"/>
            <Option name="properties"/>
        ...
        <layer class="SimpleMarker" pass="0" locked="0" id="{c6dc5af1-57a9-4734-b931-8176a5387c55}" enabled="1">
          <Option type="Map">
            <Option value="0" type="QString" name="angle"/>
            <Option value="square" type="QString" name="cap_style"/>
            <Option value="255,0,0,255" type="QString" name="color"/>
