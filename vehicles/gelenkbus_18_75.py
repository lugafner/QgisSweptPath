...
class Gelenkbus1875(Vehicle):
    ...
    def __init__(self):
        ...
        # Chassis
        self._front_axle_ref_pos = 2.77  # meter from front
        ...
        # Graphics
        self._symbol = "./gelenkbus_18_75.svg"
        self._symbol_size_x = 10.60  # SVG symbol size x in QGIS style units (usually meters)
